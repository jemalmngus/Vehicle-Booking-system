    ...
    <main class="app-main">
        <div class="app-content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6"><h3 class="mb-0">Create Notification</h3></div>
                    <div class="col-sm-6">
                            ...
                            <form action="{{ route('notifications.store') }}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" name="is_read" value="1" class="form-check-input" id="is_read" @checked(old('is_read'))>
